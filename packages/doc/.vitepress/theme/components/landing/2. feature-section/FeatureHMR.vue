...
<template>
  <div class="feature-card" id="hmr-card" @mouseover.stop.prevent="startAnimation">
    <div class="feature__visualization">
      <!-- Terminal / IDE (left-side) -->
      <div class="terminal" :class="{ active: terminalActive }">
        <svg class="terminal__line-numbers" width="8" height="125" viewBox="0 0 8 121" fill="none"
        ...
        <svg class="terminal__skeleton-lines" width="198" height="106" viewBox="0 0 198 106" fill="none"
          xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      <!-- Browser (right-side) -->
      <svg class="browser" :class="{ active: browserActive }" width="350" height="223" viewBox="0 0 348 223" fill="none"
        xmlns="http://www.w3.org/2000/svg">
        <g class="browser__background" filter="url(#shadow)">
          <rect x="17" y="-33" width="442" height="237" rx="18" fill="#242424" fill-opacity="1" />
        </g>
        <path
        ...
        <path class="browser__major-edge"
          ...
          fill="#575757" />
        <path class="browser__heading-edge"
          ...
          fill="#575757" />
        <path class="browser__tagline-edge"
        ...
        <g filter="url(#browser-glow-filter)">
          <path class="browser__major-glow"
            d="M46.4409 -7.97533C46.4409 -9.60131 47.759 -10.9194 49.385 -10.9194H427.702C429.328 -10.9194 430.646 -9.60132 430.646 -7.97533V74.4594C430.646 76.0854 429.328 77.4035 427.702 77.4035H49.385C47.759 77.4035 46.4409 76.0854 46.4409 74.4594V-7.97533Z"
            fill="#575757" />
          <path class="browser__heading-glow"
            d="M134.764 95.0681C134.764 93.4422 136.082 92.124 137.708 92.124H339.379C341.005 92.124 342.323 93.4422 342.323 95.0681V100.956C342.323 102.582 341.005 103.9 339.379 103.9H137.708C136.082 103.9 134.764 102.582 134.764 100.956V95.0681Z"
            fill="#575757" />
          <path class="browser__tagline-glow"
            d="M214.255 114.205C214.255 112.579 215.573 111.261 217.199 111.261H256.944C258.57 111.261 259.888 112.579 259.888 114.205V120.093C259.888 121.719 258.57 123.037 256.944 123.037H217.199C215.573 123.037 214.255 121.719 214.255 120.093V114.205Z"
            fill="#575757" />
        </g>
        <defs>
          ...
          <filter id="browser-glow-filter" x="24" y="-33" width="428" height="178" filterUnits="userSpaceOnUse"
            color-interpolation-filters="sRGB">
            <feFlood flood-opacity="0" result="BackgroundImageFix" />
            <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
            <feGaussianBlur stdDeviation="8" result="glow-effect" />
          </filter>
          <linearGradient id="browser-bottom-left-square" x1="238.543" y1="145.118" x2="238.543" y2="201.056"
            gradientUnits="userSpaceOnUse">
            <stop offset="0" stop-color="#404040" />
            <stop offset="1" stop-color="#404040" stop-opacity="0" />
          </linearGradient>
          <linearGradient id="browser-bottom-middle-square" x1="238.543" y1="145.118" x2="238.543" y2="201.056"
            gradientUnits="userSpaceOnUse">
            <stop offset="0" stop-color="#404040" />
            <stop offset="1" stop-color="#404040" stop-opacity="0" />
          </linearGradient>
          <linearGradient id="browser-bottom-right-square" x1="238.543" y1="145.118" x2="238.543" y2="201.056"
            gradientUnits="userSpaceOnUse">
            <stop offset="0" stop-color="#404040" />
            <stop offset="1" stop-color="#404040" stop-opacity="0" />
          </linearGradient>
...
.feature__visualization {
  ...
  .connecting-lines__line {
    height: 2px;
    border-radius: 1px;
    background: linear-gradient(to left, #FF4DB8, #FF4DB800);
    position: absolute;
    ...
    &:nth-child(3) {
      --base-width: 240px;
      background: linear-gradient(to right, #E1009800, #c063ed);
      top: 145px;
