...
<template>
  <div class="feature-card" id="rich-features-card" :class="{ active: isCardActive }"
    @mouseover.stop.prevent="startAnimation">
    <div class="feature__visualization">
      <div class="card-container">
        <svg class="background-cards" width="658" height="275" viewBox="0 0 658 275" xmlns="http://www.w3.org/2000/svg">
          <path
...
.feature__visualization {
  ...
  .card-container {
    flex-shrink: 0;
    mask-image: radial-gradient(ellipse 50% 45% at center 25%,
        rgba(0, 0, 0, 1) 50%,
        rgba(0, 0, 0, 0.7) 80%,
        rgba(0, 0, 0, 0) 100%);
    position: relative;
