...
<template>
  <div id="instant-server-start-card" class="feature-card" @mouseover.stop.prevent="startAnimation">
    <div class="feature__visualization">
      <div class="terminal" :class="{ 'terminal--active': commandTriggered }">
        ...
        <Transition name="command-transition">
          <svg class="terminal__command" width="110" height="15" viewBox="0 0 110 15" v-show="!commandTriggered"
        ...
        <Transition name="command-transition">
          <svg class="terminal__enter" width="28" height="28" viewBox="0 0 28 28" v-show="!commandTriggered" fill="none"
            ...
            <rect x="0.5" y="0.5" width="27" height="27" rx="3.92105" stroke="white" stroke-opacity="0.1" />
            ...
            <path
              ...
              fill="#FAFAFA" />
            <defs>
              <filter id="filter0_f_693_14840" x="1.31445" y="2" width="24.6855" height="24.6855"
                filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                <feFlood flood-opacity="0" result="BackgroundImageFix" />
                <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
                <feGaussianBlur stdDeviation="3" result="effect1_foregroundBlur_693_14840" />
              </filter>
              <linearGradient id="paint0_linear_693_14840" x1="14" y1="0" x2="14" y2="28"
                gradientUnits="userSpaceOnUse">
                <stop stop-color="#404040" />
                <stop offset="1" stop-color="#262626" />
              </linearGradient>
              <linearGradient id="paint1_linear_693_14840" x1="14" y1="0" x2="14" y2="28"
                gradientUnits="userSpaceOnUse">
    ...
    <div class="feature__meta">
      <div class="meta__title">Instant Setup & Integration</div>
      <div class="meta__description">
        Get started in minutes with our quick setup and seamless integration with popular social platforms.
      </div>
    </div>
  </div>
</template>
    ...
    * {
    ...
    .terminal__glow {
      ...
      background:
        ...
        radial-gradient(ellipse 140% 80% at 96% bottom,
          #13b351 0%,
          transparent 50%);
      filter: blur(15px);
      opacity: 0;
