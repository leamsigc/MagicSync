...
<template>
  <div class="w-64 border-r border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-900">
    <div class="p-3">
      <UButton label="New Chat" icon="i-heroicons-plus" color="primary" variant="solid" class="w-full"
    ...
    <div class="overflow-y-auto max-h-[calc(100vh-8rem)]">
      <div v-for="thread in threads" :key="thread.id"
        ...
        <UButton icon="i-heroicons-trash" color="error" variant="ghost" size="xs"
          class="opacity-0 group-hover:opacity-100 transition-opacity" @click.stop="emit('delete', thread.id)" />
      </div>
