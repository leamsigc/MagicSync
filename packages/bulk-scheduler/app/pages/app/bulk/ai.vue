...
/**
 * Component Description: Bulk Scheduler - AI Generator Page
...
const steps = computed(() => [
    { label: 'AI Chat', icon: 'i-heroicons-sparkles' },
...
<template>
    <UContainer class="py-8 max-w-4xl">
        <UCard>
            ...
            <BulkImportAi v-if="currentStep === 0" v-model:parsedPosts="parsedPosts" @next="nextStep" />
