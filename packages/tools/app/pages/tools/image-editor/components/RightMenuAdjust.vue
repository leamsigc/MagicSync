...
const updateTextSettings = (settings: ITextProps) => {
  if (activeLayer.value?.type === 'i-text' || activeLayer.value?.type === 'text') {
    try {
      ...
      toast.add({ title: 'Text updated', color: 'green', icon: 'lucide:check' });
    } catch (error) {
      toast.add({ title: 'Failed to update text', color: 'red', icon: 'lucide:x' });
    }
  }
};
...
const handleShadowUpdate = () => {
  try {
    if (shadow.value.enabled) {
      ...
      toast.add({ title: 'Shadow applied', color: 'green', icon: 'lucide:check' });
    } else {
      removeShadow();
      toast.add({ title: 'Shadow removed', color: 'green', icon: 'lucide:check' });
    }
  } catch (error) {
    toast.add({ title: 'Failed to update shadow', color: 'red', icon: 'lucide:x' });
  }
};
...
const handleStrokeUpdate = () => {
  try {
    ...
    toast.add({ title: 'Stroke updated', color: 'green', icon: 'lucide:check' });
  } catch (error) {
    toast.add({ title: 'Failed to update stroke', color: 'red', icon: 'lucide:x' });
  }
};
...
const handleBackgroundUpdate = () => {
  try {
    if (background.value.type === 'none') {
      clearBackground();
      toast.add({ title: 'Background cleared', color: 'green', icon: 'lucide:check' });
    } else if (background.value.type === 'solid') {
      setBackgroundColor(background.value.solidColor);
      toast.add({ title: 'Background color applied', color: 'green', icon: 'lucide:check' });
      ...
      toast.add({ title: 'Gradient applied', color: 'green', icon: 'lucide:check' });
    }
  } catch (error) {
    toast.add({ title: 'Failed to update background', color: 'red', icon: 'lucide:x' });
  }
};
...
const handleOpacityUpdate = () => {
  try {
    ...
    toast.add({ title: 'Opacity updated', color: 'green', icon: 'lucide:check' });
  } catch (error) {
    toast.add({ title: 'Failed to update opacity', color: 'red', icon: 'lucide:x' });
  }
};
...
const handleTextPropsUpdate = () => {
  try {
    ...
    toast.add({ title: 'Text properties updated', color: 'green', icon: 'lucide:check' });
  } catch (error) {
    toast.add({ title: 'Failed to update text properties', color: 'red', icon: 'lucide:x' });
  }
};
...
const handleObjectFillUpdate = () => {
  try {
    if (activeLayer.value) {
      ...
      activeLayer.value.setCoords();
      editor.value?.fabricCanvas?.requestRenderAll();
      toast.add({ title: 'Fill color updated', color: 'green', icon: 'lucide:check' });
    }
  } catch (error) {
    toast.add({ title: 'Failed to update fill', color: 'red', icon: 'lucide:x' });
  }
};
const handleFilterUpdate = (filterType: any) => {
  try {
    ...
    toast.add({ title: `${filterType} adjusted`, color: 'green', icon: 'lucide:check' });
  } catch (error) {
    toast.add({ title: `Failed to adjust ${filterType}`, color: 'red', icon: 'lucide:x' });
  }
};
...
const handlePresetUpdate = () => {
  try {
    ...
    toast.add({ title: `Filter ${presetFilter.value} applied`, color: 'green', icon: 'lucide:check' });
  } catch (error) {
    toast.add({ title: 'Failed to apply filter', color: 'red', icon: 'lucide:x' });
  }
};
      ...
      <template #shadow>
        <div class="space-y-4 pb-2 pt-2">
          <div class="flex items-center justify-between">
            ...
            <UToggle v-model="shadow.enabled" @update:model-value="handleShadowUpdate" size="sm" />
          </div>
