<!--  Translation file -->
<i18n src="./email.json"></i18n>

<script lang="ts" setup>
/**
 *
 * Component Description: Email Templates Page - List and manage email templates
 *
...
const TEMPLATE_TYPE = 'EMAIL' as const
...
<template>
    <div class="container mx-auto py-6 space-y-6">
        ...
        <div v-else class="flex flex-col items-center justify-center py-16 space-y-4">
            <div class="p-6 rounded-full bg-primary/10">
                <Icon name="lucide:mail" class="size-12 text-primary" />
            </div>
