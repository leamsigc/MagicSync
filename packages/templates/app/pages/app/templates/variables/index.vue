<!--  Translation file -->
<i18n src="./variables.json"></i18n>

<script lang="ts" setup>
/**
 *
 * Component Description: Variable Templates Page - List and manage variable templates
 *
...
<template>
    <div class="container mx-auto py-6 space-y-6">
        ...
        <div v-else class="flex flex-col items-center justify-center py-16 space-y-4">
            <div class="p-6 rounded-full bg-warning/10">
                <Icon name="lucide:code" class="size-12 text-warning" />
            </div>
