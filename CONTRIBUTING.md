...
- **[Discord chat](https://discord.magicSync.com)**: To chat with people [Discord chat](https://discord.magicSync.com/) and a quicker feedback.
...
Again, do check the [developer guide](https://doc.magicsync.dev/developer-guide). Much of what you probably need to know is in there.

If you encounter any issues, please visit our [support page](https://doc.magicsync.dev/support) or check the community forums. 
Your contributions help make MagicSync even better!
