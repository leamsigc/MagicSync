...
| Command | Description |
|---------|-------------|
| `/onboard` | Scan codebase, read key files, provide project summary |
| `/build <plan>` | Execute a saved plan from `.agent/plans/` |
| `/tdd` | Run TDD workflow for feature development |
